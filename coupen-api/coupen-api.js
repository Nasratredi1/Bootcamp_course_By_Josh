const express = require('express');  // require import a liberary 
const mongoose = require('mongoose'); // liberary which is used for the interface of MongoDBs   // this means import Mongoose into our file.
...
const coupons = require('./controllers/coupens');
